...
SCHEMAS = {
    "trades.csv": [
        ...
        "bet_number", "cumulative_spent", "bankroll_used_pct",
    ],
    "markets.csv": [
...
class ResearchLogger:
    ...
    def record_trade(self, **kw):
        ...
        row = {
            ...
            "fine_band": band,
            "regime": regime,
            "bet_number": kw.get("bet_number"),
            "cumulative_spent": kw.get("cumulative_spent"),
            "bankroll_used_pct": kw.get("bankroll_used_pct"),
        }
